  ...
  return (
    <li className="relative md:flex md:flex-1">
      <div className="flex items-center space-x-4 px-6 py-4 text-sm font-medium leading-5">
        <div
          className={`flex h-10 w-10 flex-shrink-0 items-center justify-center border-2 ${active ? 'border-amber-600' : 'border-white'
        ...
        <p
          className={`text-sm font-medium leading-5 ${active ? 'text-white' : 'text-amber-200'
            }`}
        >
          {description}
        </p>
