...
const TBody = ({ children }: TBodyProps) => {
  return (
    <tbody className="divide-y divide-border bg-background-secondary">{children}</tbody>
  );
};
...
const TH = ({
  ...
  const style = [
    'px-4 py-3 bg-border text-left text-xs leading-4 font-medium text-text-primary uppercase tracking-wider truncate',
  ];
